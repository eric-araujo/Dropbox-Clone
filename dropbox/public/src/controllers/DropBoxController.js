class DropBoxController {
    ...
    connectFirebase() {
        ...
        var firebaseConfig = {
            ...
            authDomain: "dropboxclone-d2665.firebaseapp.com",
            databaseURL: "https://dropboxclone-d2665.firebaseio.com",
            projectId: "dropboxclone-d2665",
            storageBucket: "dropboxclone-d2665.appspot.com",
            messagingSenderId: "879110791104",
            appId: "1:879110791104:web:4df80f301d35bde0"
        };
        // Initialize Firebase
        ...
        li.addEventListener('click', event => {
            ...
            if (event.shiftKey) {
                ...
                if (firstLi) {
                    ...
                    let indexStart;
                    let indexEnd;
                    let lisEl = li.parentElement.childNodes;

                    lisEl.forEach((element, index) => {
